...
export const IntelligenceService = {
  ...
  async getSellingRecommendations(lotId) {
    const res = await axios.get(
      `${API_BASE_URL}/recommendations/lot/${lotId}`
    );
  ...
  async getRecommendationOptions(lotId) {
    const res = await axios.get(
      `${API_BASE_URL}/recommendations/lot/${lotId}/options`
    );
  ...
  async matchBuyers(params) {
    const res = await axios.post(
      `${API_BASE_URL}/recommendations/buyers`,
      params
    );
  ...
  // Get market intelligence and ranked crop opportunities
  async getMarketIntelligence() {
    const res = await axios.get(
      `${API_BASE_URL}/recommendations/market-intelligence`
    );
